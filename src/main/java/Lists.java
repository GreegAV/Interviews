...
///////////////////////////////////////////////////////////////////////////////////
        ...
        System.out.println("---------------------------------------");
        List<Integer> llist = getLinkedList(count);
        List<Integer> alist = getArrayList(count);

        System.out.println("Linked vs Array getting from the end:");
        System.out.println("Array: " + getFromTheList(alist, "end") + " ms");
        System.out.println("Link: " + getFromTheList(llist, "end") + " ms");
//////////////////////////////////////////////////////////////////////////
        System.out.println("Linked vs Array getting from the start:");
        System.out.println("Array: " + getFromTheList(alist, "start") + " ms");
        System.out.println("Link: " + getFromTheList(llist, "start") + " ms");
/////////////////////////////////////////////////////////////////////////////////////
        System.out.println("Linked vs Array getting from the center:");
        System.out.println("Array: " + getFromTheList(alist, "center") + " ms");
        System.out.println("Link: " + getFromTheList(llist, "center") + " ms");
    }
